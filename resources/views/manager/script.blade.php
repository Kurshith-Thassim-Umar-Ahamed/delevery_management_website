<script src="manager/assets/vendors/js/vendor.bundle.base.js"></script>
    ...
    <script src="manager/assets/vendors/chart.js/Chart.min.js"></script>
    <script src="manager/assets/vendors/progressbar.js/progressbar.min.js"></script>
    <script src="manager/assets/vendors/jvectormap/jquery-jvectormap.min.js"></script>
    <script src="manager/assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="manager/assets/vendors/owl-carousel-2/owl.carousel.min.js"></script>
    <!-- End plugin js for this page -->
    <!-- inject:js -->
    <script src="manager/assets/js/off-canvas.js"></script>
    <script src="manager/assets/js/hoverable-collapse.js"></script>
    <script src="manager/assets/js/misc.js"></script>
